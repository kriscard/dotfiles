return {
  ...
  extensions = {
       ...
       vim.keymap.set('n', '<leader>ss', builtin.grep_string,	 { desc = 'Searches for the string under your cursor or selection in your current working directory' })
       vim.keymap.set('n', '<leader>/', builtin.live_grep,	 { desc = 'Lists open buffers in current neovim instance' })
       ...
       vim.keymap.set('n', '<leader>ss', builtin.grep_string,	 { desc = 'Searches for the string under your cursor in current working directory' })
       ...
       vim.keymap.set('n', '<leader>sd', builtin.diagnostics,	 { desc = 'Lists Diagnostics for all open buffers or a specific buffer' })
       vim.keymap.set('n', 'gr', builtin.lsp_implementations,	 { desc = "Goto the implementation of the word under the cursor" })
       vim.keymap.set('n', 'gd', builtin.lsp_definitions,	 { desc = "Goto the implementation of the word under the cursor" })
       vim.keymap.set('n', 'gt', builtin.lsp_type_definitions,		 { desc = "Goto the definition of the type of the word under the cursor" })

        -- Git Pickers
       vim.keymap.set('n', '<leader>gc', builtin.git_commits, { desc = 'List git commits with diff preview' })
       vim.keymap.set('n', '<leader>gC', builtin.git_bcommits, { desc = "Lists buffer's git commits with diff preview" })
       ...
       -- Treesitter Picker
        vim.keymap.set('n', '<leader>tt', builtin.treesitter,	 { desc = 'Lists Function names, variables, from Treesitter!' })
      end
}
